    ...
    if($_POST['$password_1']!=$_POST['$password_2']){
     ...
     if(mysqli_connect_error()){
        ...
        echo "'Connect Error('. mysqli_connect_errno().')'. mysqli_connect_error()";
             ...
             $user_check_query = "SELECT Uemail From user Where Uemail ='$email' Limit 1";
          ...
          // if user exists
              ...
              $query = "INSERT INTO user (UFname, ULastname, Uname,Uaddress,Uemail,Upassword,Ugender,PhoneCode,PhoneNumber) 
              VALUES('$firstname','$lastname','$username', '$address', '$email','$password','$gender',' $phonecode','$phonenumber')";
            if( mysqli_query($conn, $query)){

              $id=mysqli_insert_id();
              $cquery=" insert into tblproduct (uid)values('$id')";
